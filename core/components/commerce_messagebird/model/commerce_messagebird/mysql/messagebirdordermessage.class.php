<?php
require_once strtr(realpath(dirname(dirname(__FILE__))), '\\', '/') . '/messagebirdordermessage.class.php';
/**
 ...
 */
class MessageBirdOrderMessage_mysql extends MessageBirdOrderMessage
{
